...
-- The idea is that we take a Rate from currency a to currency b and a Rate from currency b to currency c
-- and by multiplying those we get a Rate from currency a to currency c
